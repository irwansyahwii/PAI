...
(function() {
  var GenericIntroLayerWithAnim_1067x548, IntroLayerBase,
  ...
  GenericIntroLayerWithAnim_1067x548 = (function(superClass) {
    extend(GenericIntroLayerWithAnim_1067x548, superClass);

    function GenericIntroLayerWithAnim_1067x548(options) {
      ...
      GenericIntroLayerWithAnim_1067x548.__super__.constructor.call(this, this.options);
      this.is_start = true;
    ...
    GenericIntroLayerWithAnim_1067x548.prototype.init = function() {
      GenericIntroLayerWithAnim_1067x548.__super__.init.apply(this, arguments);
    ...
    GenericIntroLayerWithAnim_1067x548.prototype.onBackgroundLayerStateDidSwitch = function(prevState, stateName) {
    ...
    GenericIntroLayerWithAnim_1067x548.prototype.playTextAnimation = function() {
      var captionAnim;
    ...
    GenericIntroLayerWithAnim_1067x548.prototype.hideAllInstantly = function() {
    ...
    GenericIntroLayerWithAnim_1067x548.prototype.play = function() {
      var delayValue;
      delayValue = 3;
      if (this.is_start) {
        delayValue = 0;
    ...
    return GenericIntroLayerWithAnim_1067x548;

  })(IntroLayerBase);

  module.exports = GenericIntroLayerWithAnim_1067x548;
